...
import us.graymatterapps.dualitylauncher.components.HomeLayout
import us.graymatterapps.dualitylauncher.components.ResizeFrame
...
class WidgetContainer(
    ...
    private fun convertToDeleted() {
        widgetDB.deleteWidget(appWidgetId)
        this.removeAllViews()
        parentLayout.removeView(this)
        listener.onWidgetChanged()
    }
