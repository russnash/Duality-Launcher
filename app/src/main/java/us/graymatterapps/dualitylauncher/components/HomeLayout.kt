...
class HomeLayout(context: Context, attributeSet: AttributeSet?) : ViewGroup(
            ...
            if (dragEvent != null) {
                ...
                when (dragEvent.action) {
                    ...
                    DragEvent.ACTION_DROP -> {
                        val params = dragImage.layoutParams as LayoutParams
                        this.removeView(dragImage)
    ...
    private fun isCellOccupied(row: Int, column: Int): Boolean {
        for (n in 0 until this.childCount) {
            val params = this.getChildAt(n).layoutParams as LayoutParams
    ...
    private fun findClosestCell(xpos: Float, ypos: Float): LayoutParams {
    ...
    override fun generateLayoutParams(attrs: AttributeSet?): ViewGroup.LayoutParams {
        return super.generateLayoutParams(attrs) as LayoutParams
    }
